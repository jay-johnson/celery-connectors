...
setup(
    ...
    long_description="For running headless celery subscribers and " +
    "kombu publishers to process json or pickled messages using a " +
    "celery-ready messaging backend. Headless means no task " +
